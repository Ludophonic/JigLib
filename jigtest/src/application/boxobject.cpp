...
// SetProperties
//==============================================================
void tBoxObject::SetProperties(tScalar elasticity, 
...
// tBoxObject
//==============================================================
tBoxObject::tBoxObject(JigLib::tVector3 sides, bool randomColour)
{
  TRACE_METHOD_ONLY(ONCE_2);
  
  mCollisionSkin.AddPrimitive(tBox(-0.5f * sides, 
                              tMatrix33::Identity(), 
...
// SetDensity
//==============================================================
void tBoxObject::SetDensity(tScalar density, tPrimitive::tPrimitiveProperties::tMassDistribution massType)
{
...
// SetMass
//==============================================================
void tBoxObject::SetMass(tScalar mass, tPrimitive::tPrimitiveProperties::tMassDistribution massType)
{
  mBody.SetMass(mass);
...
// SetRenderPosition
//==============================================================
void tBoxObject::SetRenderPosition(tScalar renderFraction)
{
...
//==============================================================
const tSphere & tBoxObject::GetRenderBoundingSphere() const
{
...
// GetRenderPosition
//==============================================================
const tVector3 & tBoxObject::GetRenderPosition() const
{
...
//==============================================================
const tMatrix33 & tBoxObject::GetRenderOrientation() const
{
...
// Render
//==============================================================
void tBoxObject::Render(tRenderObject::tRenderType renderType)
{
  TRACE_METHOD_ONLY(FRAME_2);
